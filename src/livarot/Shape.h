...
private:
  ...
  void AddChgt (int lastPointNo, int lastChgtPt, Shape * &shapeHead,
		...
		int rB);
  void CheckAdjacencies (int lastPointNo, int lastChgtPt, Shape * shapeHead,
			 int edgeHead);
  void CheckEdges (int lastPointNo, int lastChgtPt, Shape * a, Shape * b,
		   BooleanOp mod);
  void Avance (int lastPointNo, int lastChgtPt, Shape * iS, int iB, Shape * a,
