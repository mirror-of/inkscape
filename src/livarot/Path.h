...
public:
	...
	void            LineTo(float ix,float iy);
	void            LineTo(float ix,float iy,float iw);
	void            CubicTo(float ix,float iy,float isDx,float isDy,float ieDx,float ieDy);
	void            CubicTo(float ix,float iy,float isDx,float isDy,float ieDx,float ieDy,float iw);
	void            ArcTo(float ix,float iy,float iRx,float iRy,float angle,bool iLargeArc,bool iClockwise);
	void            ArcTo(float ix,float iy,float iRx,float iRy,float angle,bool iLargeArc,bool iClockwise,float iw);
	void            IntermBezierTo(float ix,float iy); // add a quadratic bezier spline control point
	void            IntermBezierTo(float ix,float iy,float iw);
	void            BezierTo(float ix,float iy); // quadratic bezier spline to this point (control points can be added after this)
	void            BezierTo(float ix,float iy,float iw);
	void            TempBezierTo(void); // start a quadratic bezier spline (control points can be added after this)
	void            TempBezierToW(void);
	void            EndBezierTo(void);
	void            EndBezierTo(float ix,float iy);  // ends a quadratic bezier spline (for curves started with TempBezierTo)
	void            EndBezierTo(float ix,float iy,float iw);
