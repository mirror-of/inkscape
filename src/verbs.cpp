...
Verb *Verb::_base_verbs[] = {
    ...
    new ZoomVerb(SP_VERB_VIEW_TOGGLE_NAV, "ViewNavModeToggle", N_("Toggle _Navigation Mode"),
                 N_("Show a navigation on the screen"), nullptr),
