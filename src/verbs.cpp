...
static const SPVerbActionDef props[] = {
    ...
    {SP_VERB_TOGGLE_RULERS, "ToggleRulers", N_("Rulers"), N_("Show or hide rulers"), "rulers"},
    {SP_VERB_TOGGLE_SCROLLBARS, "ToggleScrollbars", N_("Scrollbars"), N_("Show or hide scrollbars"), "scrollbars"},
    {SP_VERB_TOGGLE_GRID, "ToggleGrid", N_("Grid"), N_("Show or hide grid"), "grid"},
    {SP_VERB_TOGGLE_GUIDES, "ToggleGuides", N_("Guides"), N_("Show or hide guides"), "guides"},
    {SP_VERB_ZOOM_NEXT, "ZoomNext", N_("Nex_t zoom"), N_("Next zoom (from the history of zooms)"),
        "zoom_next"},
    {SP_VERB_ZOOM_PREV, "ZoomPrev", N_("Pre_v zoom"), N_("Previous zoom (from the history of zooms)"),
        "zoom_previous"},
    ...
    {SP_VERB_FULLSCREEN, "FullScreen", N_("_Fullscreen"), N_("Stretch this document window to full screen"),
        "fullscreen"},
#endif /* HAVE_GTK_WINDOW_FULLSCREEN */
    {SP_VERB_VIEW_NEW, "ViewNew", N_("_New View"), N_("Open a new window with the same document"),
        "view_new"},
    ...
    {SP_VERB_HELP_KEYS, "HelpKeys", N_("_Keys and Mouse"),
        N_("Reference sheet for key and mouse shortcuts"), "help_keys"},
