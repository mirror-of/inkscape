...
static const SPVerbActionDef props[] = {
    ...
    {SP_VERB_FILE_EXPORT, "FileExport", N_("_Export Bitmap..."),
        N_("Export document as PNG bitmap"), "file_export"},
    ...
    {SP_VERB_EDIT_CUT, "EditCut", N_("Cu_t"),
        N_("Cut selected objects to clipboard"), GTK_STOCK_CUT},
    {SP_VERB_EDIT_COPY, "EditCopy", N_("_Copy"),
        N_("Copy selected objects to clipboard"), GTK_STOCK_COPY},
    ...
    /* Selection */
    {SP_VERB_SELECTION_TO_FRONT, "SelectionToFront", N_("Raise to Top"),
        N_("Raise selection to top"), "selection_top"},
    {SP_VERB_SELECTION_TO_BACK, "SelectionToBack", N_("Lower to Bottom"),
    ...
    {SP_VERB_SELECTION_CUT, "SelectionDivide", N_("Division"),
        N_("Cut the bottom object into pieces"), NULL},
    {SP_VERB_SELECTION_SLICE, "SelectionCutPath", N_("Cut Path"),
    ...
    {SP_VERB_SELECTION_SIMPLIFY, "SelectionSimplify", N_("Simp_lify Path"),
    ...
    {SP_VERB_TOGGLE_RULERS, "ToggleRulers", N_("Rulers"),
        N_("Show/hide rulers"), "rulers"},
    {SP_VERB_TOGGLE_SCROLLBARS, "ToggleScrollbars", N_("Scrollbars"),
        N_("Show/hide scrollbars"), "scrollbars"},
    {SP_VERB_TOGGLE_GRID, "ToggleGrid", N_("Grid"), N_("Show/hide grid"), "grid"},
    {SP_VERB_TOGGLE_GUIDES, "ToggleGuides", N_("Guides"),
        N_("Show/hide guides"), "guides"},
    {SP_VERB_ZOOM_NEXT, "ZoomNext", N_("Nex_t zoom"), N_("Next zoom"),
        "zoom_next"},
    {SP_VERB_ZOOM_PREV, "ZoomPrev", N_("Pre_v zoom"), N_("Previous zoom"),
        "zoom_previous"},
    ...
    {SP_VERB_ZOOM_PAGE_WIDTH, "ZoomPageWidth", N_("Page _Width"),
        N_("Fit page width in window"), "zoom_pagewidth"},
    ...
    {SP_VERB_DIALOG_TRANSFORM, "DialogTransform", N_("Transfor_m"),
        N_("Object transformations"), "object_trans"},
    {SP_VERB_DIALOG_ALIGN_DISTRIBUTE, "DialogAlignDistribute",
        N_("_Align and Distribute"), N_("Align and distribute objects"),
        "object_align"},
