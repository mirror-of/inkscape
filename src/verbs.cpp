...
static const SPVerbActionDef props[] = {
	...
	{SP_VERB_SELECTION_SIMPLIFY, "SelectionSimplify", N_("Si_mplify Path"), N_("Simplify selected path"), NULL},
	...
	{SP_VERB_ZOOM_1_1, "Zoom1:0", N_("_Zoom 1:1"), N_("Zoom to 1:1"), "zoom_1_to_1"},
	{SP_VERB_ZOOM_1_2, "Zoom1:2", N_("Zoom _1:2"), N_("Zoom to 1:2"), "zoom_1_to_2"},
	{SP_VERB_ZOOM_2_1, "Zoom2:1", N_("Zoom _2:1"), N_("Zoom to 2:1"), "zoom_2_to_1"},
	...
	/* Dialogs */
	{SP_VERB_DIALOG_DISPLAY, "DialogDisplay", N_("In_kscape Options"), N_("Global Inkscape options"), NULL},
	{SP_VERB_DIALOG_DOCUMENT, "DialogDocument", N_("D_ocument Settings"), N_("Settings for the current document"), NULL},
	{SP_VERB_DIALOG_NAMEDVIEW, "DialogNamedview", N_("Editing _Window"), N_("Editing window properties"), NULL},
	...
	{SP_VERB_DIALOG_TRANSFORM, "DialogTransform", N_("_Transform"), N_("Object transformations"), "object_trans"},
	...
	{SP_VERB_DIALOG_ITEM, "DialogItem", N_("Ite_m Properties"), N_("Item properties"), NULL},
	/* Footer */
