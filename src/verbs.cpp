...
static const SPVerbActionDef props[] = {
    ...
    {SP_VERB_FILE_REVERT, "FileRevert", N_("_Revert"),
	N_("Revert to on-disk version of document"), "file_revert" },
    ...
    {SP_VERB_EDIT_CLONE_ORIGINAL, "EditCloneOriginal", N_("Select _Original"),
        N_("Select the original object to which the clone is linked"), NULL},
    ...
    /* Dialogs */
    {SP_VERB_DIALOG_DISPLAY, "DialogDisplay", N_("Inkscape _Preferences"),
