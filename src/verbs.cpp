...
static const SPVerbActionDef props[] = {
	...
	{SP_VERB_SELECTION_OFFSET, "SelectionOffset", N_("Outset path"), N_("Outset selected paths"), NULL},
	{SP_VERB_SELECTION_INSET, "SelectionInset", N_("Inset path"), N_("Inset selected paths"), NULL},
	{SP_VERB_SELECTION_OUTLINE, "SelectionOutline", N_("Stroke to path"), N_("Convert selected stroke to path"), NULL},
	...
	/* Dialogs */
	{SP_VERB_DIALOG_DISPLAY, "DialogDisplay", N_("Inkscape Options"), N_("Global Inkscape options"), NULL},
	...
	{SP_VERB_DIALOG_TRANSFORM, "DialogTransform", N_("Transform"), N_("Object transformations"), "object_trans"},
	{SP_VERB_DIALOG_ALIGN_DISTRIBUTE, "DialogAlignDistribute", N_("Align and Distribute"), N_("Align and distribute objects"), "object_align"},
