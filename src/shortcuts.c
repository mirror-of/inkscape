...
/*	sp_shortcut_set_verb (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_CONTROL_MASK | GDK_P, SP_VERB_FILE_PRINT_PREVIEW, FALSE);*/
	...
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_1, SP_VERB_SELECTION_UNION, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_2, SP_VERB_SELECTION_INTERSECT, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_3, SP_VERB_SELECTION_DIFF, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_4, SP_VERB_SELECTION_SYMDIFF, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_5, SP_VERB_SELECTION_OFFSET, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_6, SP_VERB_SELECTION_INSET, TRUE);
	sp_shortcut_set_verb (SP_SHORTCUT_CONTROL_MASK | GDK_7, SP_VERB_SELECTION_OUTLINE, TRUE);
