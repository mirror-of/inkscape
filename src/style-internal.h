 ...
 *   The "computed" value must be calculated when each style property is read.
 *
 * To summarize:
 *
 ...
 *   clear():    Set a property to its default value and unset the 'set' flag to false.
...
public:
    ...
    virtual void merge(   SPIBase* const parent ) {}; // To do: Set to 0
...
public:
    ...
    // virtual void cascade( SPIBase* const parent );  // Use SPILength::cascade
    virtual void merge(   SPIBase* const parent );
...
public:
    ...
    virtual void cascade( SPIBase* const parent ) {}; // Done in SPITextDecorationLine
    virtual void merge(   SPIBase* const parent ) {}; // Done in SPITextDecorationLine
