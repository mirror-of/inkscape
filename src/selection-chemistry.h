...
void sp_selection_scale_relative (SPSelection *selection, NRPoint *align, double dx, double dy);
void sp_selection_rotate_relative (SPSelection *selection, NRPoint *center, gdouble angle);
void sp_selection_skew_relative (SPSelection *selection, NRPoint *align, double dx, double dy);
