...
public:
    ...
    std::vector<SPItem*> getItemsInBox(unsigned int dkey, Geom::Rect const &box, bool take_hidden = false, bool take_insensitive = false, bool into_groups = false, bool into_filtered_groups = true, bool with_groups = false) const;
    std::vector<SPItem*> getItemsPartiallyInBox(unsigned int dkey, Geom::Rect const &box, bool take_hidden = false, bool take_insensitive = false, bool into_groups = false, bool into_filtered_groups = true, bool with_groups = false) const;
