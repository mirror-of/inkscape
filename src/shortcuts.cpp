...
/*	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_CONTROL_MASK | GDK_P, SP_VERB_FILE_PRINT_PREVIEW, false);*/
	...
	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | GDK_n, SP_VERB_EDIT_CLONE, true);
	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | GDK_N, SP_VERB_EDIT_CLONE, false);

	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_CONTROL_MASK | GDK_n, SP_VERB_EDIT_UNLINK_CLONE, true);
	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_CONTROL_MASK | GDK_N, SP_VERB_EDIT_UNLINK_CLONE, false);
