...
/*	sp_shortcut_set (SP_SHORTCUT_ALT_MASK | SP_SHORTCUT_CONTROL_MASK | GDK_P, SP_VERB_FILE_PRINT_PREVIEW, false);*/
	...
	sp_shortcut_set (SP_SHORTCUT_ALT_MASK | GDK_t, SP_VERB_EDIT_TILE, true);
	sp_shortcut_set (SP_SHORTCUT_ALT_MASK | GDK_T, SP_VERB_EDIT_TILE, true);

	//	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_ALT_MASK | GDK_t, SP_VERB_EDIT_UNTILE, true);
	//	sp_shortcut_set (SP_SHORTCUT_SHIFT_MASK | SP_SHORTCUT_ALT_MASK | GDK_T, SP_VERB_EDIT_UNTILE, true);
