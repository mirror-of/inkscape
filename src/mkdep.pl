...
sub make_files {
    ...
    # print file
    print OFILES "# Do not edit this file! It is automatically generated by mkdep.pl. Changes will be lost.\n\n";
...
sub make_dep {
    ...
    print DEP "# Do not edit this file! It is automatically generated by mkdep.pl. Changes will be lost.\n\n";
    print DEP $text;
    close DEP;
    print STDERR "\n";
