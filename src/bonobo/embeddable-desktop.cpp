...
static void sp_embeddable_desktop_activate ( BonoboView * view, 
                                             gboolean activate, 
                                             gpointer data );

/* fixme: this should go to main desktop */
void sp_embeddable_desktop_size_allocate ( GtkWidget * widget, 
...
sp_embeddable_desktop_get_type (void)
{
    ...
    if (!type) {
        ...
        type = bonobo_x_type_unique ( BONOBO_EMBEDDABLE_TYPE, NULL, NULL, 0, 
                                      &info );
    }
    return type;
}
...
static void
sp_embeddable_desktop_activate ( BonoboView * view, 
                                 gboolean activate, 
                                 gpointer data )
{
    SPEmbeddableDesktop * desktop;
...
void
sp_embeddable_desktop_new_doc ( BonoboView * view, 
                                gpointer data )
{
    SPEmbeddableDesktop * desktop;
    ...
    sp_desktop_change_document ( desktop->desktop->desktop, 
...
void
sp_embeddable_desktop_size_allocate ( GtkWidget * widget, 
                                      GtkAllocation * allocation, 
                                      gpointer data )
{
