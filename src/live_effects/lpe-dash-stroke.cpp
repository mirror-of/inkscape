...
LPEDashStroke::LPEDashStroke(LivePathEffectObject *lpeobject)
    ...
    stroke_dasharray(_("Dash Array"), _("Coma separated values for dashes and holes"), "stroke_dasharray", &wr, this,"1mm,1mm"),
    stroke_dashcorner(_("Dash corner"), _("Lenght value or none"), "stroke_dashcorner", &wr, this,"none"),
    stroke_dashoffset(_("Dash offset"), _("Lenght value or perent"), "stroke_dashcorner", &wr, this,"0"),
    message(_("Info Box"), _("Important messages"), "message", &wr, this, _("Add <b>\"Fill Between Many LPE\"</b> to add fill."))
{
    ...
    registerParameter(&stroke_dashofset);
    registerParameter(&message);
    message.param_set_min_height(30);
    stroke_dasharray.param_hide_canvas_text();
    stroke_dashoffset.param_hide_canvas_text();
    stroke_dashcorner.param_hide_canvas_text();
}
