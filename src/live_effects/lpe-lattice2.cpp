...
LPELattice2::doBeforeEffect (SPLPEItem const* lpeitem)
{
    ...
    setDefaults();
    Geom::Line vert(grid_point_8x9.param_getDefault(),grid_point_10x11.param_getDefault());
    Geom::Line horiz(grid_point_24x26.param_getDefault(),grid_point_25x27.param_getDefault());
    if(vertical_mirror) {
...
LPELattice2::setDefaults()
{
    ...
    grid_point_0.param_updateDefault(gp0);
    grid_point_1.param_updateDefault(gp1);
    grid_point_2.param_updateDefault(gp2);
    grid_point_3.param_updateDefault(gp3);
    grid_point_4.param_updateDefault(gp4);
    grid_point_5.param_updateDefault(gp5);
    grid_point_6.param_updateDefault(gp6);
    grid_point_7.param_updateDefault(gp7);
    grid_point_8x9.param_updateDefault(gp8x9);
    grid_point_10x11.param_updateDefault(gp10x11);
    grid_point_12.param_updateDefault(gp12);
    grid_point_13.param_updateDefault(gp13);
    grid_point_14.param_updateDefault(gp14);
    grid_point_15.param_updateDefault(gp15);
    grid_point_16.param_updateDefault(gp16);
    grid_point_17.param_updateDefault(gp17);
    grid_point_18.param_updateDefault(gp18);
    grid_point_19.param_updateDefault(gp19);
    grid_point_20x21.param_updateDefault(gp20x21);
    grid_point_22x23.param_updateDefault(gp22x23);
    grid_point_24x26.param_updateDefault(gp24x26);
    grid_point_25x27.param_updateDefault(gp25x27);
    grid_point_28x30.param_updateDefault(gp28x30);
    grid_point_29x31.param_updateDefault(gp29x31);
    grid_point_32x33x34x35.param_updateDefault(gp32x33x34x35);
    grid_point_0.param_setLiveupdate(live_update);
    grid_point_1.param_setLiveupdate(live_update);
    grid_point_2.param_setLiveupdate(live_update);
    grid_point_3.param_setLiveupdate(live_update);
    grid_point_4.param_setLiveupdate(live_update);
    grid_point_5.param_setLiveupdate(live_update);
    grid_point_6.param_setLiveupdate(live_update);
    grid_point_7.param_setLiveupdate(live_update);
    grid_point_8x9.param_setLiveupdate(live_update);
    grid_point_10x11.param_setLiveupdate(live_update);
    grid_point_12.param_setLiveupdate(live_update);
    grid_point_13.param_setLiveupdate(live_update);
    grid_point_14.param_setLiveupdate(live_update);
    grid_point_15.param_setLiveupdate(live_update);
    grid_point_16.param_setLiveupdate(live_update);
    grid_point_17.param_setLiveupdate(live_update);
    grid_point_18.param_setLiveupdate(live_update);
    grid_point_19.param_setLiveupdate(live_update);
    grid_point_20x21.param_setLiveupdate(live_update);
    grid_point_22x23.param_setLiveupdate(live_update);
    grid_point_24x26.param_setLiveupdate(live_update);
    grid_point_25x27.param_setLiveupdate(live_update);
    grid_point_28x30.param_setLiveupdate(live_update);
    grid_point_29x31.param_setLiveupdate(live_update);
    grid_point_32x33x34x35.param_setLiveupdate(live_update);
}

void
LPELattice2::resetGrid()
{
    grid_point_0.param_valueFromDefault();
    grid_point_1.param_valueFromDefault();
    grid_point_2.param_valueFromDefault();
    grid_point_3.param_valueFromDefault();
    grid_point_4.param_valueFromDefault();
    grid_point_5.param_valueFromDefault();
    grid_point_6.param_valueFromDefault();
    grid_point_7.param_valueFromDefault();
    grid_point_8x9.param_valueFromDefault();
    grid_point_10x11.param_valueFromDefault();
    grid_point_12.param_valueFromDefault();
    grid_point_13.param_valueFromDefault();
    grid_point_14.param_valueFromDefault();
    grid_point_15.param_valueFromDefault();
    grid_point_16.param_valueFromDefault();
    grid_point_17.param_valueFromDefault();
    grid_point_18.param_valueFromDefault();
    grid_point_19.param_valueFromDefault();
    grid_point_20x21.param_valueFromDefault();
    grid_point_22x23.param_valueFromDefault();
    grid_point_24x26.param_valueFromDefault();
    grid_point_25x27.param_valueFromDefault();
    grid_point_28x30.param_valueFromDefault();
    grid_point_29x31.param_valueFromDefault();
    grid_point_32x33x34x35.param_valueFromDefault();
}
