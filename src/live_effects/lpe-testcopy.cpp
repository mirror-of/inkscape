#define INKSCAPE_LPE_TESTCOPY_CPP
/** \file
...
LPETestcopy::LPETestcopy(LivePathEffectObject *lpeobject) :
    Effect(lpeobject),
...
LPETestcopy::doEffect_path (std::vector<Geom::Path> const & path_in)
{
        ...
        Geom::Point displacement = Geom::Point(1, -3); 
        path_out = path_in + displacement;   
