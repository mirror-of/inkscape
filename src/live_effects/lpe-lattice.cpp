...
LPELattice::resetDefaults(SPItem const* item)
{
    ...
    grid_point1.param_updateDefault(grid_point1);
    grid_point2.param_updateDefault(grid_point2);
    grid_point3.param_updateDefault(grid_point3);
    grid_point4.param_updateDefault(grid_point4);
    grid_point5.param_updateDefault(grid_point5);
    grid_point6.param_updateDefault(grid_point6);
    grid_point7.param_updateDefault(grid_point7);
    grid_point8.param_updateDefault(grid_point8);
    grid_point9.param_updateDefault(grid_point9);
    grid_point10.param_updateDefault(grid_point10);
    grid_point11.param_updateDefault(grid_point11);
    grid_point12.param_updateDefault(grid_point12);
    grid_point13.param_updateDefault(grid_point13);
    grid_point14.param_updateDefault(grid_point14);
    grid_point15.param_updateDefault(grid_point15);
}
