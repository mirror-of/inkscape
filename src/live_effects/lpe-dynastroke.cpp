    ...
    capping(_("Capping:"), _("left capping"), "capping", &wr, this, "M 100,5 C 50,5 0,0 0,0 0,0 50,-5 100,-5")
{
    ...
    width.param_setRange(0, Geom::infinity());
    roundness.param_setRange(0.01, 1);
    angle.param_setRange(-360, 360);
    growfor.param_setRange(0, Geom::infinity());
    fadefor.param_setRange(0, Geom::infinity());
