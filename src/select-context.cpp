...
static void sp_selection_moveto(SPSelTrans *seltrans, NR::Point const &xy, guint state)
{
    ...
    // status text
    GString *xs = SP_PT_TO_METRIC_STRING(dxy[X], (SPMetric) sp_desktop_get_default_metric(desktop));
    GString *ys = SP_PT_TO_METRIC_STRING(dxy[Y], (SPMetric) sp_desktop_get_default_metric(desktop));
