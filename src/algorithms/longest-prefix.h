/*
 * Inkscape::Algorithms::longest_prefix
 *
 * Authors:
...
#ifndef SEEN_INKSCAPE_ALGORITHMS_LONGEST_PREFIX_H
#define SEEN_INKSCAPE_ALGORITHMS_LONGEST_PREFIX_H
...
#endif /* !SEEN_INKSCAPE_ALGORITHMS_LONGEST_PREFIX_H */
