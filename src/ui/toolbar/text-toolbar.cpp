    ...
    , _cusor_numbers(0)
{
    ...
    }
    {
        ...
        _line_height_adj = Gtk::Adjustment::create(line_height_val, 0.0, 100000.0, 0.1, 1.0);
        _line_height_item =
    ...
    /* Letter spacing */
    {
        ...
        _letter_spacing_adj = Gtk::Adjustment::create(letter_spacing_val, -100000.0, 100000.0, 0.01, 0.10);
    ...
    /* Word spacing */
    {
        ...
        _word_spacing_adj = Gtk::Adjustment::create(word_spacing_val, -100000.0, 100000.0, 0.01, 0.10);
    ...
    /* Character kerning (horizontal shift) */
    {
        ...
        _dx_adj = Gtk::Adjustment::create(dx_val, -100000.0, 100000.0, 0.01, 0.1);
    ...
    /* Character vertical shift */
    {
        ...
        _dy_adj = Gtk::Adjustment::create(dy_val, -100000.0, 100000.0, 0.01, 0.1);
