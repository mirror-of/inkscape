...
protected:
    ...
    Gtk::TreeView _AutoEmbedScriptsList;
    Gtk::TreeView _AutoUnembedScriptsList;
    ...
    Gtk::ScrolledWindow _AutoEmbedScriptsListScroller;
    Gtk::ScrolledWindow _AutoUnembedScriptsListScroller;
