...
void InkscapePreferences::initPageUI()
{
    ...
    // CanvasNGonGrid properties:
        ...
        _grids_ngon_sect_n.init("/options/grids/ngon/sect_n", 3.0, 360.0, 1.0, 3.0, 8.0, true, false);
        _grids_ngon.add_line( false, _("Number of sections:"), _grids_ngon_empspacing, "", "", false);
        _grids_ngon_spacing_x.init("/options/grids/ngon/spacing_x", 0.0, 10000.0, 0.1, 1.0, 1.0, false, false);
        _grids_ngon_spacing_y.init("/options/grids/ngon/spacing_y", 0.0, 10000.0, 0.1, 1.0, 1.0, false, false);
        _grids_ngon_spacing_x.set_digits(5);
        _grids_ngon_spacing_y.set_digits(5);
        _grids_ngon.add_line( false, _("Spacing X:"), _grids_ngon_spacing_x, "", _("Distance between concentric grid polygons"), false);
        _grids_ngon.add_line( false, _("Spacing Y:"), _grids_ngon_spacing_y, "", _("Distance between semi-radial grid lines"), false);
        _grids_ngon_rotation.init("/options/grids/ngon/rotation", -360.0, 360.0, 1.0, 0.0, 0.0, false, false);
        _grids_ngon_rotation.set_digits(5);
        _grids_ngon.add_line( false, _("Rotation:"), _grids_ngon_rotation, "", _("Angle of axis rotation"), false);
