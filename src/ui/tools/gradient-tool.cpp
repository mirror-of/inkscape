...
void GradientTool::selection_changed(Inkscape::Selection*) {
    ...
    if (n_sel == 1) {
        if (drag->singleSelectedDraggerNumDraggables() == 1) {
            ...
            gchar * message = g_strconcat(
                ...
                ngettext("One handle merging <tt>%d</tt> stop (drag with <b>Shift</b> to separate) selected",
                         "One handle merging <tt>%d</tt> stops (drag with <b>Shift</b> to separate) selected",drag->singleSelectedDraggerNumDraggables()),
                ngettext(" out of <tt>%d</tt> gradient handle"," out of <tt>%d</tt> gradient handles",n_tot),
                ngettext(" on <tt>%d</tt> selected object"," on <tt>%d</tt> selected objects",n_obj),NULL);
        ...
        gchar * message = g_strconcat(ngettext("<b><tt>%d</tt></b> gradient handle selected out of <tt>%d</tt>","<b>%d</b> gradient handles selected out of %d",n_sel),
        ...
        rc->message_context->setF(Inkscape::NORMAL_MESSAGE,
                                   ...
                                   ngettext("<b>No</b> gradient handles selected out of <tt>%d</tt> on <tt>%d</tt> selected object",
                                            "<b>No</b> gradient handles selected out of <tt>%d</tt> on <tt>%d</tt> selected objects",n_obj), n_tot, n_obj);
    }
}
