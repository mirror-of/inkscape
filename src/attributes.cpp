...
static SPStyleProp const props[] = {
    ...
    {SP_ATTR_RULERMULTIPLIERX, "inkscape:rulermultiplierx"},
    {SP_ATTR_RULERMULTIPLIERY, "inkscape:rulermultipliery"},
    {SP_ATTR_RULEROFFSETX, "inkscape:ruleroffsetx"},
    {SP_ATTR_RULEROFFSETY, "inkscape:ruleroffsety"},
