...
enum {
    ...
    SP_VERB_SELECTION_FILL_BETWEEN_MANY,
    /* Layer */
    SP_VERB_LAYER_NEW,
    ...
    /* Snapping */
    SP_VERB_TOGGLE_SNAP_GLOBAL,
    SP_VERB_TOGGLE_SNAP_BBOX,
    SP_VERB_TOGGLE_SNAP_NODE,
    SP_VERB_TOGGLE_SNAP_OTHERS,
    SP_VERB_TOGGLE_SNAP_ROTATION_CENTER,
    SP_VERB_TOGGLE_SNAP_GRID,
    SP_VERB_TOGGLE_SNAP_GUIDE,
    SP_VERB_TOGGLE_SNAP_NODE_SMOOTH,
    SP_VERB_TOGGLE_SNAP_LINE_MIDPOINT,
    SP_VERB_TOGGLE_SNAP_OBJECT_MIDPOINT,
    SP_VERB_TOGGLE_SNAP_TEXT_BASELINE,
    SP_VERB_TOGGLE_SNAP_BBOX_EDGE_MIDPOINT,
    SP_VERB_TOGGLE_SNAP_BBOX_MIDPOINT,
    SP_VERB_TOGGLE_SNAP_PATH_INTERSECTION,
    SP_VERB_TOGGLE_SNAP_PATH,
    SP_VERB_TOGGLE_SNAP_PATH_CLIP,
    SP_VERB_TOGGLE_SNAP_PATH_MASK,
    SP_VERB_TOGGLE_SNAP_NODE_CUSP,
    SP_VERB_TOGGLE_SNAP_BBOX_EDGE,
    SP_VERB_TOGGLE_SNAP_BBOX_CORNER,
    SP_VERB_TOGGLE_SNAP_PAGE_BORDER,
