if(WIN32)
  ...
  install(FILES
    ...
    ${MINGW_BIN}/libgdk-win32-2.0-0.dll
    ${MINGW_BIN}/libgdk_pixbuf-2.0-0.dll
    ${MINGW_BIN}/libgdkmm-2.4-1.dll
    ...
    ${MINGW_BIN}/libgtkmm-2.4-1.dll
    ${MINGW_BIN}/libgtkspell-0.dll
  ...
  install(DIRECTORY ${MINGW_PATH}/share/themes/MS-Windows
    DESTINATION ${CMAKE_INSTALL_PREFIX}/share/themes)

  # install gtk2 translations as they're needed for stock items
