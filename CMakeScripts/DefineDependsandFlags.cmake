...
if(WITH_PYTHON)
        ...
        if (PYTHONLIBS_FOUND)
		list(APPEND INKSCAPE_INCS_SYS ${PYTHON_INCLUDE_DIR})
		list(APPEND INKSCAPE_LIBS ${PYTHON_LIBRARIES})
        else()
                set(WITH_PYTHON OFF)
        endif()
        message("Searching pygtk")
        find_package(Pygtk REQUIRED)
        if (PYGTK_FOUND)
		list(APPEND INKSCAPE_INCS_SYS ${PYGTK_INCLUDE_DIRS})
        else()
                set(WITH_PYTHON OFF)
        endif()
        message("includes: " ${INKSCAPE_INCS_SYS})
        message("libs: " ${INKSCAPE_LIBS})
