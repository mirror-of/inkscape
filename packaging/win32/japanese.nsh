...
LangString lng_LICENSE_BOTTOM_TEXT   ${LANG_JAPANESE} "$(^Name) は GNU General Public License (GPL) の下でリリースされます。あくまで参考のためにライセンスをここに提示します。$_CLICK"
...
; Languages section
LangString lng_Languages $(LANG_JAPANESE) "翻訳"
...
LangString lng_en_US@piglatin $(LANG_JAPANESE) "英語（ピッグラテン、米国）"
...
LangString lng_nb $(LANG_JAPANESE) "nb  ノルウェー語（ブークモール）"
LangString lng_nl $(LANG_JAPANESE) "nl  オランダ語"
LangString lng_nn $(LANG_JAPANESE) "nn  ノルウェー語（ニーノシク）"
...
LangString lng_rw $(LANG_JAPANESE) "rw  キンヤルワンダ語"
...
LangString lng_sr@latin $(LANG_JAPANESE) "sr@latin  セルビア語（ラテン）"
