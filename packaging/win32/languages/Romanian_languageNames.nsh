...
${LangFileString} lng_sat@deva "Santali în script Devanagari (sat@deva)"
${LangFileString} lng_sd "Sindhi (sd)"
${LangFileString} lng_sd@deva "Sindhi în script Devanagari (sd@deva)"
