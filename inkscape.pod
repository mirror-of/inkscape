...
Specify the filename for PNG export.  If it already exists, the file
...
Alternatively, use `| COMMAND' to specify a different command to pipe
...
B<Copyright (C)> 1999-2018 by Authors.
