...
<xsl:variable name="style-title" select="'fill:black;fill-opacity:1;stroke:none;font-family:Bitstream Vera Sans;font-style:italic;font-weight:bold;font-size:7.4;text-anchor:start;writing-mode:lr;letter-spacing:0;'"/>
